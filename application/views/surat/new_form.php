        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?= base_url('surat');?>"><i class="fas fa-arrow-left">Back</i></a>
              ...
              <form action="<?php base_url('surat/add') ?>" method="post" enctype="multipart/form-data" >
              <div class="form-group">
                <label for="perihal">perihal</label>
                <input class="form-control <?php echo form_error('perihal') ? 'is-invalid':'' ?>"
                 type="text" name="perihal" placeholder="Perihal" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('ditujukan') ? 'is-invalid':'' ?>"
                 type="text" name="ditujukan" min="0" placeholder="Ditujukan" />
                <div class="invalid-feedback">
